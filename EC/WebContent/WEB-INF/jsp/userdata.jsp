					...
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								...
								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=${d.id}" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
									<td class="center">${d.formatDate}</td>
									<td class="center">${d.deliveryMethodName}</td>
									<td class="center">${d.totalPrice}円</td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
