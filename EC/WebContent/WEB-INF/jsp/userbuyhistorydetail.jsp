				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table>
							...
							<tbody>
								<tr>
									<td class="center">${userDetail.formatDate}</td>
									<td class="center">${userDetail.deliveryMethodName}</td>
									<td class="center">${userDetail.totalPrice}円</td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="card-content">
						<table class="bordered">
							...
							<c:forEach var="item" items="${i}" >
								...
								<tr>
									<td class="center">${userDetail.deliveryMethodName}</td>
									<td class="center">${userDetail.deliveryMethodPrice}円</td>
							</tbody>
						</table>
					</div>
				</div>
